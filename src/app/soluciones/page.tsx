...
import heroImg from "../../../public/servicios/servicios01.webp";
import Image from "next/image";

import { FC } from "react";

const SolucionesPage: FC = function () {
  return (
    <Container>
      <Container className="flex flex-wrap-reverse ">
      ...
      <div className="flex items-center justify-center w-full lg:w-1/2">
          <div className="">
            <Image
              ...
              height="500"
              className={
                "transition-transform duration-300 transform hover:scale-105 object-cover rounded-2xl"
              }
        ...
        <div className="flex items-center justify-center w-full lg:w-1/2 md:p-5">
          <div className="max-w-2xl mb-8">
            <h1 className="pt-10 text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:pt-0 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
              Servicios Diseñados Para Ofrecer El Mejor Confort Para Ti y Tu
              Peludito
            </h1>
            ...
            <div className="transition-transform duration-300 transform hover:scale-105 flex items-center justify-center sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              ...
              >
                <span>
                  No olvidez que siempre esta nuestro wassap disponible
                </span>
              </a>
            </div>
          </div>
