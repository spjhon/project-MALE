const ContactIcon = () => {
  return (
    <svg
      ...
      viewBox="0 -0.5 17 17"
      version="1.1"
      className="si-glyph si-glyph-bubble-message-dot"
    >
      <title>1088</title>
