...
export const Cta = () => {
  return (
    <Container>
      <div className="flex flex-col lg:flex-row lg:flex-nowrap items-center justify-center lg:justify-between w-full max-w-4xl gap-5 mx-auto text-white bg-indigo-600 px-7 py-2 lg:px-12 lg:py-12 rounded-xl">
        
        
        <Image src={drawpet01.src} alt="drawanimal" width={100} height={100}></Image>
        ...
        <div className="flex-grow text-center lg:text-left">
          <h2 className="text-2xl font-medium lg:text-3xl">
            ¿Te apuntas al mejor servico de cuidado de mascotas?
          </h2>
          <p className="mt-2 font-medium text-white text-opacity-90 lg:text-xl">
            Que tus michis y lomitos se sientan en casa a pesar de que no estés.
          </p>
        </div>
